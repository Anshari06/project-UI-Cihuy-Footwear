...
@section('admin-title', 'Tambah Pengguna')
    ...
    <form action="{{ route('admin.pengguna.store') }}" method="POST">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <input type="text" name="username" class="form-control" placeholder="Nama pengguna" required value="{{ old('username') }}"
            ...
            <div class="col-md-6">
                <label class="form-label" style="font-size: 13px; font-weight: 600; color: #2b2b2b;">Password</label>
