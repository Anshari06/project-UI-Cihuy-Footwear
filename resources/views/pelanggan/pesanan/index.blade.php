...
@if ($pesanan->isEmpty())
    <div class="text-center py-5">
        ...
        <a href="{{ route('collection') }}" class="btn"
            style="background: #545350; color: #fff; border-radius: 8px; padding: 10px 24px; font-weight: 600; font-size: 14px; text-decoration: none;">
            Mulai Belanja
        </a>
    </div>
@else
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="history-items-preview">
                                @foreach ($p->details->take(3) as $item)
                                    <div class="history-thumb">
                                        <img src="{{ asset('images/cihuy/' . $item->barang->image) }}"
                        ...
                        <div class="col-md-3">
                            <div class="history-alamat">
                                ...
                                <div style="color: #2b2b2b; font-size: 13px;">{{ $p->alamat }}</div>
                            </div>
                        </div>
